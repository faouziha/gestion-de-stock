...
import { FaTrash, FaEye, FaSearch, FaUserShield, FaTimes } from 'react-icons/fa';
          ...
          <>
            ...
            {showModal && selectedUser && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className={`relative rounded-lg shadow-lg max-w-2xl w-full ${darkMode ? 'bg-gray-800' : 'bg-white'} p-6`}>
                  <button
            ...
            {confirmDelete && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className={`relative rounded-lg shadow-lg max-w-md w-full ${darkMode ? 'bg-gray-800' : 'bg-white'} p-6`}>
                  <h2 className={`text-xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                    Confirm Deletion
                  </h2>
