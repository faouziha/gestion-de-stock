    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="max-w-3xl mx-auto">
                ...
                <form onSubmit={addProduit} className="bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className="p-6 border-b border-gray-200">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="mt-1 text-xs text-gray-500">Upload an image of your product (max 5MB)</p>
                        </div>
