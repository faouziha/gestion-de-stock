...
export default function AddProduct() {
    ...
    const [formData, setFormData] = useState({
        ...
        category_id: '',
        brand_id: '',
        user_id: user.id // Initialize with the current user's ID
    });
    ...
    const addProduit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3000/produit', formData);
            ...
            if (error.response) {
                ...
                setError(`Failed to add product: ${error.response.data.details || error.response.data.error || 'Unknown server error'}`);
        ...
        <div className={`p-4 sm:p-6 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-800'} min-h-screen transition-colors`}>
            <div className="max-w-3xl mx-auto">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-0">
                    <h1 className={`text-xl sm:text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'}`}>Create New Product</h1>
                    <button
                ...
                <form onSubmit={addProduit} className={`${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg rounded-lg overflow-hidden transition-colors`}>
                    <div className={`p-4 sm:p-6 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                        <div className="mb-6">
                            ...
                            <input 
                                ...
                                className={`w-full px-3 py-2 border ${darkMode ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300 text-gray-700'} rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 shadow-sm transition-colors`} 
                            ...
                            <div>
                                ...
                                <div className="relative rounded-md shadow-sm">
                                    ...
                                    <input 
                                        ...
                                        value={formData.prix}
                                        onChange={handleChange}
                                        className={`w-full pl-7 px-3 py-2 border ${darkMode ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300 text-gray-700'} rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors`} 
                                        placeholder="0.00" 
                                        step="0.01"
                                        min="0"
                                        required
                            ...
                            <div>
                                ...
                                <div className="relative rounded-md shadow-sm">
                                    <input 
                                        ...
                                        onChange={handleChange}
                                        className={`w-full px-3 py-2 border ${darkMode ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300 text-gray-700'} rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors`} 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <div className="mt-2 flex justify-between items-center">
                                    <p className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Categorize your product</p>
                                    <button
                                        type="button"
                        ...
                        <div className="mb-6">
                            ...
                            <p className={`mt-1 text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Upload an image of your product (max 5MB)</p>
                        </div>
                    ...
                    <div className={`px-4 sm:px-6 py-4 ${darkMode ? 'bg-gray-700' : 'bg-gray-50'} flex flex-col sm:flex-row sm:justify-end gap-2 transition-colors`}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed w-full sm:w-auto"
                        >
                            {loading ? (
